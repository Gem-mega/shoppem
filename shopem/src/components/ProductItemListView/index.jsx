...
const ProductItem = () => {
  return (
    <div className="productItem rounded-md !mt-5 shadow-lg overflow-hidden border-2 border-[rgba(0,0,0,0.1)] flex items-center">
      <div className="imgWrapper group w-[25%] h-[250px] rounded-md overflow-hidden relative">
        <Link to="/">
      ...
      <div className="info !p-3  w-[75%]  gap-2 !px-8 ">
        <h6 className="text-[15px]">
          <Link to="/" className="link transition-all">
            Sloyent
          </Link>
        </h6>
        <h3 className="text-[20px] font-[500] title !mb-1 mt-1 text-[rgba(0,0,0,0.9)]">
          <Link to="/" className="link transition-all">
            JEWAR trendy jewellery set for jewellery set
          </Link>{" "}
        </h3>

        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae exercitationem beatae officia corrupti
           sapiente quis numquam? Culpa ad optio deserunt. Dolores laborum consequatur nisi fugiat porro officiis quas molestias ut.</p>
